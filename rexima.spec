...
Rexima to oparty na bibliotece ncurses interaktywny mikser. Może być
używany również z linii poleceń. Jest to prosta, rozsądna
implementacja. Oprócz suwaków pokazuje też ustawione wartości.
Powinien działać na każdym terminalu o rozmiarze co najmniej 80x24.
